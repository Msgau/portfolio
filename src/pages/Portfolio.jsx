    ...
    <div className="works">
      ...
      <div style={loading ? { display: "none" } : { display: "block" }}>
        ...
        >
          <div
            className="block"
            onClick={() => openModal(CineCrew, CineCrew2, projectData[0])}
          >
            <img
              src={CineCrew}
          ...
          <div
            className="block"
            onClick={() => openModal(Kasa, Kasa2, projectData[1])}
          >
            <img
              src={Kasa}
              alt="Projet Kasa"
          ...
          <div
            className="block"
            onClick={() => openModal(MVG, MVG2, projectData[2])}
          >
            <img
              src={MVG}
          ...
          <div
            className="block"
            onClick={() => openModal(Nina, Nina2, projectData[3])}
          >
            <img
              src={Nina}
